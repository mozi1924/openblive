...
export function SettingsTab({
  ...
  return (
    <div className="relative mx-auto max-w-4xl pb-24">
      ...
      <div className="sticky bottom-4 z-20 mt-6 flex items-center justify-between gap-4 rounded-xl border border-white/8 bg-[#070a0f]/90 px-5 py-3.5 shadow-md backdrop-blur-lg">
        <div>
