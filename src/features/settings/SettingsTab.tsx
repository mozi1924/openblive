...
export function SettingsTab({
  ...
  return (
    <div className="relative mx-auto max-w-4xl space-y-6 pb-28">
      ...
      <section className="glass-panel rounded-3xl border border-amber-400/15 bg-amber-500/[0.03] p-5">
        <button
          type="button"
        ...
        >
          <div className="flex items-center space-x-2">
            <Globe className="h-4.5 w-4.5 text-amber-300" />
        ...
        <p className="mt-2 text-xs text-gray-400">{t(locale, "ui.settings.advanced.desc")}</p>
        <div className="mt-3 flex justify-end">
          <button
            type="button"
            onClick={clearAdvancedConfig}
            className="rounded-xl border border-amber-300/25 px-3 py-1.5 text-[10px] font-semibold text-amber-100 transition-colors hover:border-amber-200/40 hover:bg-amber-200/10"
          >
        ...
        {showAdvanced && (
          <div className="mt-4 grid grid-cols-1 gap-3 sm:grid-cols-2">
            ...
            <p className="sm:col-span-2 text-[10px] text-gray-500 leading-relaxed">
