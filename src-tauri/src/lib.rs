...
use commands::{
    ...
    poll_login_status, push_app_log, refresh_all_account_profiles_inner, refresh_current_user,
    refresh_live_client_version, refresh_live_client_version_inner, refresh_tray_menu,
    remove_black_user, remove_live_tag, remove_room_admin, remove_silent_user, render_qrcode,
    ...
    #[cfg(desktop)]
    {
        builder = builder.plugin(
            tauri_plugin_window_state::Builder::new()
                .with_state_flags(commands::managed_window_state_flags())
                .build(),
        );
    }
